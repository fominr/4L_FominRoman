...
class TrunkCar {
    ...
    let power: Int      // мощность
    let year: Int       // год
    let bagageMax: Int  // грузоподъемность авто
    var bagageWeight: Int   // вес груза в машине
    var cargo: Int          //вес груза, который хотим погрузить
    var engineStart: EngineStatus
    var windowOpen: WindowSatus
    var bagage: BagageStatus
    
    init (brand: String, power: Int, year: Int,bagageMax: Int,bagageWeight: Int, cargo: Int, engineStart: EngineStatus, windowOpen: WindowSatus, bagage: BagageStatus) {
     
        self.brand = brand
        self.power = power
        self.year = year
        self.bagageMax = bagageMax
        self.bagageWeight = bagageWeight
        self.cargo = cargo
...
class sportCar{
    ...
    init( brand: String, year: Int, weightCar: Int, weightTotal: Int, weightBagage: Int, window: WindowSatus, engine: EngineStatus, transmission: TransmissionStatus ) {
        
        self.brand = brand
        self.year = year
        self.weightCar = weightCar
        self.weightTotal = weightTotal
        self.weightBagage = weightBagage
        self.window = window
        self.engine = engine
